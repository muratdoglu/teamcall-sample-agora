package com.mrt.android.teamcall.ui.chat
...
class VideoChatViewActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        firebaseManager.updateFreeState(false)
    ...
    fun onLocalVideoMuteClicked(view: View) {
        ...
        if (iv.isSelected) {
            ...
            iv.isSelected = true
            iv.setColorFilter(resources.getColor(R.color.green_1000), PorterDuff.Mode.MULTIPLY)
        }
...
//      mRtcEngine!!.setVideoProfile(Constants.VIDEO_PROFILE_360P, false) // Earlier than 2.3.0
    ...
    private fun joinChannel() {
        ...
        mRtcEngine!!.joinChannel(
            token,
            intent.getStringExtra("channelId") ?: "teamcall",
            "Extra Optional Data",
            0
